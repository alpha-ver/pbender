...
class PluginsControllerTest < ActionController::TestCase
  ...
  test "should create plugin" do
    assert_difference('Plugin.count') do
      post :create, plugin: { class_name,: @plugin.class_name,, name,: @plugin.name,, setting,: @plugin.setting,, user_id: @plugin.user_id }
    end
  ...
  test "should update plugin" do
    patch :update, id: @plugin, plugin: { class_name,: @plugin.class_name,, name,: @plugin.name,, setting,: @plugin.setting,, user_id: @plugin.user_id }
    assert_redirected_to plugin_path(assigns(:plugin))
  end
